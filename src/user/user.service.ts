...
export class UserService {
    constructor(
        ...
        @InjectRepository(EventShift) private eventShiftRepo: Repository<EventShift>,
        @InjectRepository(UserShiftRequest) private userShiftRequestRepo: Repository<UserShiftRequest>,
        @InjectRepository(UserShifts) private userShiftsRepo: Repository<UserShifts>,
    ...
    async createShiftRequest(payload: ShiftRequestCreateDto): Promise<UserShiftRequest> {
    ...
    async toggleRequestStatus(requestId: string, payload: ShiftRequestUpdateDto): Promise<UserShifts> {
        ...
        try {
            ...
            await this.userShiftRequestRepo.save(shiftRequest);
            ...
            throw new Error(`Failed to toggle status for request ID ${requestId}: ${error.message}`);
        }
    }
